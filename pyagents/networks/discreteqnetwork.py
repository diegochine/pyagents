...
class DiscreteQNetwork(Network):
    ...
    def __init__(self, state_shape, action_shape,
        ...
        self._config = {'state_shape': state_shape,
                        ...
                        'conv_layer_params': conv_layer_params if conv_layer_params else tuple(),
                        'fc_layer_params': fc_layer_params if fc_layer_params else tuple(),
